...
export class BaseConfigBuilder {
    ...
    applyConfigOverrides(overrides) {
        ...
        const blacklistedKeys = new Set([
            'proxies', 'rules', 'rule-providers', 'proxy-groups',
            // Surge base-config metadata; do not leak it into other output formats
            // when a full Surge profile is used as subscription input.
            'general-lines', 'replica-lines'
        ]);
