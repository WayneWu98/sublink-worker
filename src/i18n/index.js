...
export const translations = {
  'zh-CN': {
    ...
    ruleSetType: '类型',
    ruleSetOutbound: '出站',
    ruleSetOutboundHint: '命中流量的去向：内置分组或"规则选择"里已勾选的组',
    outboundBuiltIn: '内置分组',
    outboundSelectedGroups: '已选规则组',
  ...
  'en-US': {
    ...
    ruleSetOutboundHint: 'Where matching traffic goes: a built-in policy group or any rule group you checked in Rule Selection',
    outboundBuiltIn: 'Built-in',
    outboundSelectedGroups: 'Selected rule groups',
  ...
  'fa': {
    ...
    ruleSetOutboundHint: 'مقصد ترافیک منطبق: یک گروه داخلی یا هر گروه قوانینی که در "انتخاب قوانین" علامت زده‌اید',
    outboundBuiltIn: 'داخلی',
    outboundSelectedGroups: 'گروه‌های قوانین انتخاب‌شده',
  ...
  'ru': {
    ...
    ruleSetOutboundHint: 'Куда направить трафик, попавший в набор: встроенная группа или любая отмеченная в "Выборе правил" группа',
    outboundBuiltIn: 'Встроенные',
    outboundSelectedGroups: 'Выбранные группы правил',
