...
export const translations = {
  'zh-CN': {
    ...
    customRuleResolveIP: '启用 DNS 解析',
    customRuleResolveIPTooltip: '开启后该条 IP CIDR 规则不加 no-resolve 标志。默认情况下 Clash/Surge 遇到域名流量时不会主动解析 DNS，导致 IP CIDR 规则匹配不到。开启此项可让客户端为未匹配域名规则的流量主动做 DNS 解析以比对本 IP。代价：略增 DNS 查询开销，且可能产生 DNS 泄漏，谨慎开启。仅影响 Clash/Surge 输出。',
    ...
    proxyGroupType: '类型',
    proxyGroupMembers: '成员',
    proxyGroupMembersHint: '"节点选择"=全部节点；也可选自动选择、地区/规则/规则集组、Surge 设备、其它自定义组、DIRECT/REJECT。可添加多个',
    proxyGroupMembersPlaceholder: '选择成员…',
    customRuleSetsSection: '自定义规则集',
    customRuleSetsSectionTooltip: '订阅公开规则集文件，注册为独立分组',
    ruleSetName: '规则集名称',
    ruleSetProvider: '源',
    ruleSetFile: '文件名',
    ...
    ruleSetUrlPreview: 'URL 预览',
    ruleSetUrlPreviewUnsupported: '（该源不支持此格式）',
    ruleSetType: '类型',
    ruleSetOutbound: '出站',
    ruleSetOutboundHint: '命中该规则集的流量走哪里',
    ...
    addCustomRuleSet: '添加自定义规则集',
    noCustomRuleSetsForm: '暂无自定义规则集',
  ...
  'en-US': {
    ...
    customRuleResolveIP: 'Enable DNS Resolution',
    customRuleResolveIPTooltip: 'When enabled, this IP CIDR rule is emitted without the no-resolve flag. By default Clash/Surge do not resolve DNS for hostname traffic, so IP CIDR rules never match; enabling this lets the client actively resolve DNS for unmatched traffic to compare against this IP. Trade-off: extra DNS queries and potential DNS leaks. Only affects Clash/Surge output.',
    ...
    proxyGroupType: 'Type',
    proxyGroupMembers: 'Members',
    proxyGroupMembersHint: '"Node Select" = all nodes. Also Auto Select, region/rule/ruleset groups, Surge devices, other custom groups, DIRECT/REJECT. Add as many as you like',
    proxyGroupMembersPlaceholder: 'Select members…',
    customRuleSetsSection: 'Custom Rule Sets',
    ...
    ruleSetUrlClash: 'URL (Clash)',
    ruleSetUrlSurge: 'URL (Surge)',
    ruleSetUrlPreview: 'URL preview',
    ruleSetUrlPreviewUnsupported: '(unsupported for this provider)',
    ruleSetType: 'Type',
    ruleSetOutbound: 'Outbound',
    ruleSetOutboundHint: 'Where matching traffic goes',
    outboundBuiltIn: 'Built-in outbounds',
    outboundSelectedRules: 'Selected rule groups',
    ...
    addCustomRuleSet: 'Add custom rule set',
    noCustomRuleSetsForm: 'No custom rule sets yet',
  ...
  'fa': {
    ...
    proxyGroupMembersHint: '"Node Select" = all nodes. Also Auto Select, region/rule/ruleset groups, Surge devices, other custom groups, DIRECT/REJECT. Add as many as you like',
    proxyGroupMembersPlaceholder: 'Select members…',
    customRuleSetsSection: 'مجموعه‌قوانین سفارشی',
    customRuleSetsSectionTooltip: 'اشتراک فایل‌های مجموعه‌قوانین عمومی به‌عنوان گروه‌های مستقل',
    ruleSetName: 'نام مجموعه‌قوانین',
    ruleSetProvider: 'منبع',
    ruleSetFile: 'نام فایل',
    ruleSetUrlSingbox: 'URL (sing-box)',
    ruleSetUrlClash: 'URL (Clash)',
    ruleSetUrlSurge: 'URL (Surge)',
    ruleSetUrlPreview: 'پیش‌نمایش URL',
    ruleSetUrlPreviewUnsupported: '(این منبع از این فرمت پشتیبانی نمی‌کند)',
    ruleSetType: 'نوع',
    ruleSetOutbound: 'خروجی',
    ruleSetOutboundHint: 'مقصد ترافیک منطبق',
    outboundBuiltIn: 'خروجی‌های داخلی',
    outboundSelectedRules: 'گروه‌های قوانین انتخاب‌شده',
    ...
    addCustomRuleSet: 'افزودن مجموعه‌قوانین سفارشی',
    noCustomRuleSetsForm: 'هنوز مجموعه‌قوانین سفارشی‌ای وجود ندارد',
  ...
  'ru': {
    ...
    proxyGroupMembersHint: '"Node Select" = all nodes. Also Auto Select, region/rule/ruleset groups, Surge devices, other custom groups, DIRECT/REJECT. Add as many as you like',
    proxyGroupMembersPlaceholder: 'Select members…',
    customRuleSetsSection: 'Пользовательские наборы правил',
    customRuleSetsSectionTooltip: 'Подписка на публичные файлы наборов правил как на отдельные группы',
    ruleSetName: 'Имя набора правил',
    ruleSetProvider: 'Источник',
    ruleSetFile: 'Имя файла',
    ruleSetUrlSingbox: 'URL (sing-box)',
    ruleSetUrlClash: 'URL (Clash)',
    ruleSetUrlSurge: 'URL (Surge)',
    ruleSetUrlPreview: 'Предпросмотр URL',
    ruleSetUrlPreviewUnsupported: '(не поддерживается этим источником)',
    ruleSetType: 'Тип',
    ruleSetOutbound: 'Исходящий',
    ruleSetOutboundHint: 'Куда направить трафик, попавший в набор',
    outboundBuiltIn: 'Встроенные',
    outboundSelectedRules: 'Выбранные группы правил',
    ...
    addCustomRuleSet: 'Добавить пользовательский набор правил',
    noCustomRuleSetsForm: 'Пока нет пользовательских наборов правил',
